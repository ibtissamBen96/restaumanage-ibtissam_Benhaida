...
final class Version20210318145109 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE restaurant ADD create_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, DROP created_at');
        $this->addSql('ALTER TABLE review ADD create_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, DROP created_at');
    }
